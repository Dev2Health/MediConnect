...
//			Root<Instituicao> raizInstituicao = criteria.from(Instituicao.class);
			...
			criteria.select(raizNotificacao);
//			Expression<String> ctpsExpression = raizNotificacao.get(Notificacao_.DATA);
			criteria.where(construtor.between(raizNotificacao.get(Notificacao_.DATA), dataInicial, dataFinal),
	...
	public List<Notificacao> filtrarNotificacaoViaPacientePorData(LocalDate dataInicial, LocalDate dataFinal, Paciente paciente) {
