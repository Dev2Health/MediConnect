    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <head>
                ...
                <style>
                    <%@include file="../../estilos/padroes.css" %>
                </style>
            </head>
            ...
            <body>
                ...
                <main>
                        ...
                        <div id="profile">
                            <div id="profile-presentation">
                                <div class="profile-photo">
                                    <img src="../../imagens/icone-camera.svg" alt="icone-camera">
                                    <!--Icone deve ser azul-->
                                </div>
                                <div class="profile-edit">
                                    <button class="btn-square-me text">Editar Perfil <img
                                            src="../../imagens/icone-editar.svg" alt="icone-editar"></button>
                            ...
                            <div id="profile-information">
                                ...
                                <div class="image-portion">
                                    <img class="patient-icon" src="../../imagens/icone-paciente.svg"
                                        alt="icone-paciente">
                                    <img width="100px" height="100px" src="<c:url   value="
                                        /uploadImage/${usuario.fotoPerfil}.png" />">
                                </div>
                                <div class="description-portion">
                                    <h1 class="subtitle">
                                        <c:out value="${paciente.nome}" />
                                        <c:out value="${paciente.sobrenome}" />
                                    </h1>
                                    <p class="text">
                                ...
                                <div>
                                    <div>
                                        <div></div>
                                        <!--esta belissima div é para ser o nosso querido e amado bolinh verde-->
                        ...
                        <c:forEach var="conquista" items="${conquistas}">
                            <div><!--agrupamento-->
                                ...
                                <div><!--caixa-->
                                    ...
                                    <div><!--texto-->
                                        <h2 class="subtitle">
                                            <c:out value='${conquista.nome}' />
                                        </h2>
                                        <p class="text-no-emphasis">
                                            <c:out value='${conquista.descricao}' />
                                        </p>
                                    </div>
                                    <div><!--nível-->
                                        <div>
                                            <c:if test="${pacienteConquista != null}">
                                                <p class="text-emphasis">
                                                    <c:out value='${pacienteConquista.nível}' />
                                                </p>
                                            </c:if>
                                        </div>
                                        <div>
                    ...
                    <section>
                            ...
                            <c:forEach var="consulta" items="${consultas}">
                                <div><!--caixa inteira-->
                                    ...
                                    <div><!--header da caixa-->
                                        ...
                                        <div>
                                            <p class="text-emphasis">Consulta -
                                        ...
                                        <div>
                                            <div>
                                                <div>
                                                    ...
                                                    <p class="text-emphasis" type="date">
                                                        <c:out value="${data}" />
                                                    </p>
                                                </div>
                                                <div>
                                                    <p class="text emphasis">
                                                        <c:out value='${consulta.horario}' />
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <p class="text-no-emphasis">
                                                    <c:out value='${consulta.descricao}' /><span
                                                        class="text-emphasis">...ver mais</span>
                                                </p>
                                            </div>
                        ...
                        <a href="./consultas" class="btn-square-sm text">Ver todas <img
                                src="../../imagens/icone-seta.svg"></a>
                    </section>
